...
#==============================================================================
# Performs data segmentation
def data_segmentation(data, sampling_rate, window_size, overlap, num_classes):
    ...
    return segment_arr
#==============================================================================
# Performs label segmentation
def label_segmentation(labels, sampling_rate, window_size, overlap, num_classes):
    # Needed for compilation incase for loop isn't executed
    label_arr = None
    ...
    while(True):
        ...
        # Break if next increment would contain samples that are outside the data
        t = t + (window_size-overlap)
        if (t >= ((label_length/sampling_rate)-window_size)):
            break
